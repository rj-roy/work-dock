    ...
    return (
        <form method="GET" className="relative w-full lg:w-80">
            ...
            <input
                ...
                className="w-full px-6 py-3 pr-10 rounded-full bg-white dark:bg-neutral/20 border border-neutral/20 focus:border-secondary focus:ring-2 focus:ring-secondary/20 outline-none transition-all placeholder-neutral"
            />
